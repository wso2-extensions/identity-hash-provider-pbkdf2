...
package org.wso2.carbon.identity.hash.provider.pbkdf2.internal;
...
import org.wso2.carbon.identity.hash.provider.pbkdf2.PBKDF2HashProviderFactory;
...
public class PBKDF2HashServiceComponent {
    ...
    private static final Log log = LogFactory.getLog(PBKDF2HashServiceComponent.class);
